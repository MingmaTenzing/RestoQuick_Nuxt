  ...
  <div class=" space-y-6">
    ...
    <div class="flex justify-between items-center">
      ...
      <div class=" flex gap-3">
        <NuxtLink to="/print-roster"
          class=" border-border  border px-4 py-2 flex justify-center items-center space-x-2 text-card-foreground rounded-3xl">
    ...
    <div class=" flex flex-col gap-4 md:flex-row w-full">
      ...
      <!-- total staff card -->
      <div
        class="border  rounded-3xl w-full shadow   p-6 border-border bg-card text-card-foreground h-42.5 flex items-center justify-between ">
    ...
    <div class=" bg-accent py-1 px-2 rounded-3xl flex gap-4 items-center  w-105">
      ...
      <NuxtLink to="/dashboard/roster/weekly"
        :class="['px-2  py-2 rounded-3xl text-sm', route.path == '/dashboard/roster/weekly' ? 'bg-background' : '']">
        Weekly schedule</NuxtLink>
      <NuxtLink to="/dashboard/roster/leave-requests"
        :class="['px-2  py-2 rounded-3xl text-sm', route.path == '/dashboard/roster/leave-requests' ? 'bg-background' : '']">
        Leave requests</NuxtLink>
      <NuxtLink to="/dashboard/roster/staff-availability"
        :class="['px-2  py-2 rounded-3xl text-sm', route.path == '/dashboard/roster/staff-availability' ? 'bg-background' : '']">
        Staff Availability</NuxtLink>
