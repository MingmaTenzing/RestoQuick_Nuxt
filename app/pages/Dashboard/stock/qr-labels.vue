  ...
  <main class="p-4 space-y-6">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-muted-foreground">Generate scannable labels linked to stock item IDs</p>
      </div>
    ...
    <div v-else class="flex w-full flex-wrap gap-4">
      ...
      >
        ...
        <span class="text-sm text-muted-foreground text-center">Scan to open stock update page</span>
      </div>
    </div>
  </main>
</template>
