...
<template>
 ...
 <div class=" flex justify-between items-center">
  ...
  <div  class="flex items-center space-x-2 "
        ...
        <section v-if="loading_orders" class=" flex justify-center items-center h-[80vh]"> 
         
<div role="status">
    <svg aria-hidden="true" class="w-8 h-8 text-primary animate-spin fill-accent" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
