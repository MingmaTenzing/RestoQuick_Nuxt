...
<template>
  ...
  >
    <div class="w-full max-w-md rounded-3xl border border-border bg-card p-6 text-card-foreground shadow-lg">
      ...
      <div class="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
        ...
        <button
          ...
          type="button"
          class="rounded-2xl bg-destructive px-4 py-2 text-destructive-foreground transition-colors hover:bg-destructive/90"
          @click="emit('confirm')"
        >
          Delete
        </button>
