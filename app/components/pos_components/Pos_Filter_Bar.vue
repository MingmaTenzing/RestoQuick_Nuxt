    ...
    <section class="rounded-3xl border border-border bg-card p-4 shadow-sm md:p-5">
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <p class="text-[11px] font-medium uppercase tracking-[0.22em] text-muted-foreground">Menu control
                    </p>
                ...
                <div class="relative w-full lg:max-w-sm">
                    <i
                        class="pi pi-search pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-sm text-muted-foreground"></i>
                    <input :value="searchQuery" type="text" placeholder="Search menu item or description"
